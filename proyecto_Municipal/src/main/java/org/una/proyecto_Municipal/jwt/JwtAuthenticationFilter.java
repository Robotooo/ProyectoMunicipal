...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    @Autowired
    private org.una.proyecto_Municipal.jwt.JwtProvider tokenProvider;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        try {
            ...
            if (StringUtils.hasText(jwt) && tokenProvider.isValid(jwt)) {
                ...
                UserDetails userDetails = funcionarioService.loadUserByUsername(tokenProvider.getSubject(jwt));
